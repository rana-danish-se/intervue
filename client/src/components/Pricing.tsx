...
const plans = [
  ...
  },
  {
    ...
    price: "$19",
    period: "/month",
    description: "For serious candidates actively preparing for upcoming interviews.",
    features: [
  ...
  },
  {
    name: "Enterprise",
    price: "Custom",
    description: "For teams and organizations looking to train their candidates.",
    features: [
      "Everything in Pro",
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Invest in your career with plans designed to help you land your dream job.
          </motion.p>
        </div>
            ...
            >
              ...
              <ul className="space-y-4 mb-8 flex-1">
                {plan.features.map((feature, fIndex) => (
                  <li key={fIndex} className="flex items-start text-muted-foreground">
